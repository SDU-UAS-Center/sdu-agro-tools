...
Therefore, the multi-thread computaiton with ``concurrent.futures`` is implemented within a QgsTask. Find more about this in :ref:`Background Execution with QgsTask <background-execution>`.
