...
class AgroTool_ColorSegmenter:
    ...
    def run(self):
        ...
        if result == QDialog.Accepted:
            ...
            self.progressDlg.singnal.cancel_singal.connect(task.cancel)

            task.progress_signal.connect(self.progressDlg.progressBar.setValue)
            task.finish_signal.connect(self.progressDlg.close)
